...
const RegUserFormTableRow = ({ faker, fakerKey }: Props) => {
        ...
        <Table.Td className='first:rounded-l-md last:rounded-r-md w-60 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b] py-0 relative before:block before:w-px before:h-8 before:bg-slate-200 before:absolute before:left-0 before:inset-y-0 before:my-auto before:dark:bg-darkmode-400'>
          <div className='flex items-center justify-center'>
            ...
            <button className='flex items-center mr-3'>
              <Lucide icon='X' className='w-4 h-4 mr-1' /> Hủy
            </button>
          </div>
        </Table.Td>
      </Table.Tr>
      <Dialog size='xs' className='w-[700px] dark:bg-darkmode-400' open={viewDetailModal} handler={handleOpen}>
        ...
        <DialogBody>
          <div className='intro-x flex flex-col bg-white gap-[20px]'>
            ...
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div className='flex'>Email: {faker.email}</div>
            </div>
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              Loại bảo hiểm: {faker.type}
            </div>
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div className='flex'>Gói bảo hiểm:{faker.plan}</div>
            </div>
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div className='flex'>Ngày đăng ký: {faker.date}</div>
            </div>
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div
                className={clsx([
            ...
            {/* <div className='first:rounded-l-md last:rounded-r-md w-60 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b] py-0 relative before:block before:w-px before:h-8 before:bg-slate-200 before:absolute before:left-0 before:inset-y-0 before:my-auto before:dark:bg-darkmode-400'>
              <div className='flex items-center justify-center'>
                <button className='flex items-center text-danger'>
                  <Lucide icon='X' className='w-4 h-4 mr-1' /> Hủy đơn đăng ký
                </button>
              </div>
            </div> */}
          </div>
