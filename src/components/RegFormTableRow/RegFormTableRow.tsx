...
const RegFormTableRow = ({ faker, fakerKey }: Props) => {
      ...
      <Dialog size='xs' className='w-[700px] dark:bg-darkmode-400' open={viewDetailModal} handler={handleOpen}>
        ...
        <DialogBody>
          <div className='intro-x'>
            ...
            <div className='first:rounded-l-md last:rounded-r-md w-10 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div className='flex'>{faker.email}</div>
            </div>
            <div className='first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              {faker.type}
            ...
            <div className='first:rounded-l-md last:rounded-r-md w-40 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]'>
              <div
                className={clsx([
                  'flex items-center justify-center',
                  { 'text-warning': faker.status === 'pending' },
