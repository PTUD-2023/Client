...
import RegUserContractTableRow from 'src/components/RegUserContractTableRow'
...
function UserContractManagement() {
  ...
  return (
    <>
      <h2 className='mt-10 text-lg font-medium intro-y'>Danh sách hợp đồng</h2>
          ...
          <Table className='border-spacing-y-[10px] border-separate -mt-2'>
            ...
            <Table.Tbody>
              {regList.map((faker, fakerKey) => (
                <RegUserContractTableRow faker={faker} fakerKey={fakerKey} key={fakerKey} />
              ))}
            </Table.Tbody>
          </Table>
        </div>
